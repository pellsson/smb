cat intro/smb.chr intro/megaman.chr intro/kosmic.chr intro/somewes.chr intro/darbian.chr intro/andrewg.chr intro/kappa.chr intro/custom.chr > /tmp/intro_flat.chr && \
truncate --size 4096 /tmp/intro_flat.chr  && \
python ../scripts/chr2copylayout.py /tmp/intro_flat.chr intro.chr && \
